...
const { email, password, name, picture, role, svsuid, roleatsvsu } = schema.tree
 ...
 */
router.post('/',
  body({ email, password, name, picture, role, svsuid, roleatsvsu }),
  create)
...
router.put('/:id',
  token({ required: true }),
  body({ email, name, picture, role, svsuid, roleatsvsu }),
  update)
